...
var ElementMap = function (_React$Component) {
  _inherits(ElementMap, _React$Component);

  function ElementMap(props) {
    _classCallCheck(this, ElementMap);

    return _possibleConstructorReturn(this, _getPrototypeOf(ElementMap).call(this, props));
  }
...
_defineProperty(ElementMap, "defaultProps", {
