...
- **logoutFunction**(optional) a function that can provide custom logout behavior. its invoked after logging the user out of the store by dispatching the logoutActionCreator
