 ...
 */
export declare function useOAuthLogin(
  options: OAuthLoginHookOptions
): {
  [key: string]: string;
};
 ...
 */
export declare const ProviderLinks: (props: ProviderLinksProps) => React.JSX.Element;
...
declare const OauthLogin: {
  (props: OauthLoginProps): React.JSX.Element;
  defaultProps: {
    OAuthLoginPromptMessage: string;
    ProviderLinksComponent: (
      props: ProviderLinksProps
    ) => React.JSX.Element /** use the ProviderLinks component as the default */;
    authorizationGrantType: AuthorizationGrantType;
    noProvidersMessage: string;
  };
};
